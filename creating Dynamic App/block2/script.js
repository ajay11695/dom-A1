...
You will find all the code for this exercise in the code folder.
Write HTML, CSS and JavaScript in the respective files.
Create an app like the layout given below. Find the data to create the app just below the layout.
Book List App
*/
 ...
 let booklyData={
  ...
  booklyData.books.forEach(ele=>{
    ...
    img.src=ele.image
    img.style.width='40%'
    img.style.margin='1rem 0.5rem'
    h2.innerText=ele.title
    h2.style.margin='0.5rem 0'
    h2.style.fontSize='1.5rem'
    h3.innerText=`Author: ${ele.author}`
    h3.style.color='grey'
